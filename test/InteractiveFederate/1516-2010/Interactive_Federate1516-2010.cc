...
std::unique_ptr <
  ...
  temps =
  rti1516e::LogicalTimeFactoryFactory::makeLogicalTimeFactory (L"CERTI");
std::unique_ptr < rti1516e::LogicalTime > tps (temps->makeInitial ());
...
char federate_name[80];
rti1516e::InteractionClassHandle MsgHandle;
rti1516e::InteractionClassHandle MsgRHandle;
rti1516e::ParameterHandle MsgDataHandle;
rti1516e::ParameterHandle MsgDataRHandle;
rti1516e::ObjectClassHandle TestObjectClassHandle;
rti1516e::ObjectClassHandle TestObjectClassRHandle;
rti1516e::AttributeHandle DataHandle;
rti1516e::AttributeHandle DataRHandle;
rti1516e::ObjectInstanceHandle TestObjectClassInstanceHandle;
rti1516e::ObjectInstanceHandle TestObjectClassRInstanceHandle;
...
public:
  ...
  void
  receiveInteraction (rti1516e::InteractionClassHandle theInteraction,
  ...
  throw (rti1516e::FederateInternalError)
  {
    ...
    const void *
      value_data;
    rti1516e::ParameterHandleValueMap::const_iterator it;
  ...
  void
  reflectAttributeValues (rti1516e::ObjectInstanceHandle theObject,
  ...
  // Time Management
  void
  timeRegulationEnabled (rti1516e::LogicalTime const &theTime)
  throw (rti1516e::FederateInternalError)
  {
  ...
  void
  timeConstrainedEnabled (rti1516e::LogicalTime const &theTime)
  throw (rti1516e::FederateInternalError)
  {
  ...
  void
  timeAdvanceGrant (rti1516e::LogicalTime const &theTime)
  throw (rti1516e::FederateInternalError)
  {
...
private:
  ...
  rti1516e::FederateHandle fedHandle;
  RTI1516fedTime
    theTime;
...
Federe_Interactif::callGetObjInstanceHandle ()
{
  ...
  try
  {
	...
	rti1516e::ObjectInstanceHandle returnedObjHandle =
...
Federe_Interactif::callambF ()
{
  ...
  std::unique_ptr < rti1516e::RTIambassadorFactory >
    rtiAmbFact (new rti1516e::RTIambassadorFactory ());
  ...
  try
  {
    std::unique_ptr < rti1516e::RTIambassador >
      rtiAmbP (rtiAmbFact->createRTIambassador ());
...
Federe_Interactif::callDFE ()
{
  ...
  catch (rti1516e::FederationExecutionDoesNotExist & e)
  {
    test = 1;
  }
  catch (rti1516e::Exception & e)
...
Federe_Interactif::callJFE (char *name)
{
  ...
  try
  {
    rtiAmb->joinFederationExecution (wname, L"fed_i", L"Federation_Interactive");
  }
  catch (rti1516e::Exception & e)
  {
    test = false;
...
Federe_Interactif::callRFE ()
{
  ...
  {
    rtiAmb->
      resignFederationExecution (rti1516e::CANCEL_THEN_DELETE_THEN_DIVEST);
  }
  catch (rti1516e::Exception & e)
  {
    test = false;
...
Federe_Interactif::callPOCA ()
{
  ...
  rti1516e::AttributeHandleSet classAttributes;
  ...
  rti1516e::AttributeHandleSet classRAttributes;
...
Federe_Interactif::callUOCA ()
{
  ...
  rti1516e::AttributeHandle attrHandle =
...
Federe_Interactif::callROI ()
{
  ...
  std::wstring fn(federate_name, federate_name + strlen(federate_name));

  try
  {
    TestObjectClassInstanceHandle =
      rtiAmb->registerObjectInstance (TestObjectClassHandle, fn + L"object1");
      // bug if no second parameter
  ...
  try
  {
    TestObjectClassRInstanceHandle =
      rtiAmb->registerObjectInstance (TestObjectClassRHandle, fn + L"object2");
...
Federe_Interactif::callUAV ()
{
  ...
  rti1516e::AttributeHandleValueMap attributeRValues;
  rti1516e::VariableLengthData theUserSuppliedTag;

  std::string testString ("test uav");
  //rti1516e::VariableLengthData varData (testString.c_str (),
  //                                   testString.size () + 1);
  ...
  if (choix == 'y')
	...
	attributeValues.insert (std::pair < rti1516e::AttributeHandle,
				rti1516e::VariableLengthData > (DataHandle,
							       varData));
    ...
    {
      attributeRValues.insert (std::pair < rti1516e::AttributeHandle,
			       rti1516e::VariableLengthData > (DataRHandle,
							      varData));
...
Federe_Interactif::callSI ()
{
  ...
  bool test = true;
  char choix;
  rti1516e::ParameterHandleValueMap phvm;
  rti1516e::VariableLengthData tag;

  std::string testString ("test string");
  rti1516e::VariableLengthData paramValue (testString.c_str (),
					  testString.size () + 1);
  ...
  if (choix == 'y')		//SI avec estampille temporelle
	...
	" : Donner la valeur de l'estampille voulue : ";
      ...
      phvm.insert (std::pair < rti1516e::ParameterHandle,
		   rti1516e::VariableLengthData > (MsgDataHandle, paramValue));
  ...
  else				//SI sans estampille temporelle
    {
      ...
      phvm.insert (std::pair < rti1516e::ParameterHandle,
		   rti1516e::VariableLengthData > (MsgDataRHandle,
						  paramValue));
