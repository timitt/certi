...
DECLARE_ENCODING_HELPER_IMPLEMENTATION_CLASS(HLAASCIIstring, std::string)
...
DECLARE_ENCODING_HELPER_IMPLEMENTATION_CLASS(HLAoctet, Octet)
...
DECLARE_ENCODING_HELPER_IMPLEMENTATION_CLASS(HLAunicodeString, std::wstring)
//DECLARE_ENCODING_HELPER_IMPLEMENTATION_CLASS(HLA3Byte, Integer32)
